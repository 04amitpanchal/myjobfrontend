...
@Component({
  selector: 'app-emp-profile-for-visitor',
  templateUrl: './emp-profile-for-visitor.component.html',
  styleUrls: ['./emp-profile-for-visitor.component.css']
})
export class EmpProfileForVisitorComponent implements OnInit {
  emp_id:string;
  emp_password:string;
first_name:string;
last_name:string;
