...
const arr:Routes=[
  ...
  // {path:'',component:SignComponent},
    ...
    {path:'JobSingle/:id',component:JobSingleComponent},
    {path:'CompanyPostedJob',component:CompanyPostedJobsComponent},
    {path:'AppliedJobs',component:AppliedJobsComponent},
    {path:'recprofileforvisitor',component:RecProfileForVisitorComponent},
    {path:'candidateforrec',component:CandidateForRecComponent},
    {path:'empprofileforrec',component:EmpProfileRecComponent},
    {path:'empprofileforvisitor',component:EmpProfileForVisitorComponent},
    {path:'contactusforemp',component:ContactusForEmpComponent},
    {path:'contactusforrec',component:ContactusForRecComponent},
    {path:'relatedcandidates',component:RelatedCandidatesForRecComponent},
    {path:'jobsforemp',component:JobsForEmpComponent},
